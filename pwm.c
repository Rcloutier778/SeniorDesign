...
#define __LEFT_FORWARD GPIOC_PSOR |= __RIGHT_WHEEL;
#define __RIGHT_FORWARD GPIOC_PSOR |= __LEFT_WHEEL;
#define __LEFT_BACKWARD GPIOC_PCOR |= __RIGHT_WHEEL;
#define __RIGHT_BACKWARD GPIOC_PCOR |= __LEFT_WHEEL;
